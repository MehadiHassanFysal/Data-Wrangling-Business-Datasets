## 📊 Business Data Wrangling & Exploratory Analysis (Python)

This repository contains Python-based data cleaning and exploratory analysis projects using real-world business and administrative datasets. The focus is on **data preparation, inspection, and analytical reasoning**, not predictive modeling.
